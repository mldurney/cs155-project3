...
#
# Description:      Helper functions for HMM implementation for Shakespearean
...
def sample_sentence(hmm, obs_map, n_words=100):
    ...
    emission, _ = hmm.generate_emission(n_words)
...
def animate_emission(hmm, obs_map, M=8, height=12, width=12, delay=1):
    ...
    for i, wordcloud in enumerate(wordclouds):
        ...
        ax.imshow(wordcloud.to_array(), extent=(
            x - r, x + r, y - r, y + r), aspect='auto', zorder=-1)
    ...
    def animate(i):
        if i >= delay:
            ...
            if i == 0:
                ...
                arrows[states[i - 2]][states[i - 1]
                                      ].set_color((1 - hmm.A[states[i - 2]][states[i - 1]], ) * 3)
                arrows[states[i - 1]][states[i]].set_color('red')
